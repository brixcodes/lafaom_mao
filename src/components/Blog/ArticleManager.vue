<template>
  <div class="article-manager">
    ...
    <div class="d-flex align-center justify-space-between mb-6">
      <div>
        <h2 class="text-h4 font-weight-bold">Gestion des Articles</h2>
    ...
    <VCard class="mb-6">
      <VCardText>
        ...
        <!-- Info des résultats -->
        <div class="mt-4">
          <VChip v-if="hasActiveFilters" color="info" variant="tonal" prepend-icon="ri-filter-line">
    ...
    <!-- Liste des articles -->
    <VCard v-if="filteredPosts.length > 0" class="articles-table-card">
      <VCardTitle class="d-flex align-center justify-space-between">
        <div class="d-flex align-center">
          <VIcon icon="ri-article-line" class="me-2" />
          <span>Liste des articles ({{ filteredPosts.length }})</span>
        </div>
    ...
    <VCard v-else class="text-center pa-8" elevation="1">
      <VIcon :icon="hasActiveFilters ? 'ri-search-line' : 'ri-file-list-3-line'" size="80" color="grey-lighten-3" class="mb-4" />
      ...
      <p class="text-body-1 text-medium-emphasis mb-6" style="max-width: 400px; margin: 0 auto;">
        {{ hasActiveFilters ? 'Essayez de modifier vos filtres ou créez un nouvel article.' : 'Commencez par créer votre premier article pour partager vos idées avec le monde.' }}
      </p>

      <div class="d-flex gap-3 justify-center">
        <VBtn v-if="hasActiveFilters" variant="outlined" color="primary" prepend-icon="ri-refresh-line" @click="clearAllFilters">
