<template>
  ...
  >
      ...
      <template v-else>
        ...
        <VForm @submit.prevent="handleUpdate">
          ...
          <VFileInput
            ...
            :error-messages="editErrors.cover_image"
            class="mb-3"
          />
          ...
          <VTextarea
            ...
            rows="6"
            auto-grow
            :error-messages="editErrors.content"
            class="mb-3"
          />
          ...
          <VTextField
            ...
            variant="outlined"
            min="1"
            :error-messages="editErrors.position"
            class="mb-4"
          />
    ...
    <VCardActions v-if="!isEditing" class="pa-3 pt-0">
      <VChip
        size="small"
        variant="tonal"
      ...
      <VChip
        v-if="section.updated_at !== section.created_at"
        size="small"
        variant="tonal"
        color="warning"
