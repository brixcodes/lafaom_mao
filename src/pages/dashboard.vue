...
import AnalyticsTotalEarningJobsOffer from '@/views/dashboard/AnalyticsTotalEarningJobsOffer.vue'
import AnalyticsTotalEarning from '@/views/dashboard/AnalyticsTotalEarning.vue'
import AnalyticsTotalEarningCourse from '@/views/dashboard/AnalyticsTotalEarningCourse.vue'
...
<template>
  <VRow class="match-height">
    ...
    <VCol cols="12" md="4">
      <AnalyticsTotalEarningJobsOffer />
    </VCol>
