...
export enum ErrorMessage {
  ...
  // Job Offers errors
  JOB_OFFER_NOT_FOUND = 'JOB_OFFER_NOT_FOUND',
  JOB_OFFER_REFERENCE_TAKEN = 'JOB_OFFER_REFERENCE_TAKEN',
  JOB_OFFER_CLOSED = 'JOB_OFFER_CLOSED',
  JOB_APPLICATION_NOT_FOUND = 'JOB_APPLICATION_NOT_FOUND',
  JOB_ATTACHMENT_REQUIRED = 'JOB_ATTACHMENT_REQUIRED',
  INVALID_OTP_OR_APPLICATION_NOT_FOUND = 'INVALID_OTP_OR_APPLICATION_NOT_FOUND',
